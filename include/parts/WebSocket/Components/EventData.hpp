#pragma once
#ifndef _KURLYK_WEB_SOCKET_EVENT_DATA_HPP_INCLUDED
#define _KURLYK_WEB_SOCKET_EVENT_DATA_HPP_INCLUDED

/// \file EventData.hpp
/// \brief Defines the WebSocketEventData class, which encapsulates data related to WebSocket events.

#include "../../Enums.hpp"
#include "../Client/IWebSocketSender.hpp"
...
#endif // _KURLYK_WEB_SOCKET_EVENT_DATA_HPP_INCLUDED
