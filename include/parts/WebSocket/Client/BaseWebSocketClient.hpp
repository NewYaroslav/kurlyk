...
#include "../Components/SendInfo.hpp"
...
#           endif
        ...
        std::unique_ptr<WebSocketEventData> create_websocket_close_event(
                const std::string& reason = "Normal Closure", int status_code = 1000) {
            auto websocket_event = create_websocket_event();
            websocket_event->event_type = WebSocketEventType::Close;
        ...
        std::unique_ptr<WebSocketEventData> create_websocket_error_event(
            ...
            auto websocket_event = create_websocket_event();
            websocket_event->event_type = WebSocketEventType::Error;
